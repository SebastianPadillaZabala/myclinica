			...
			<div
				...
				<div class="mr-13 flex capitalize">
					...
					<div
						...
						dark:text-gray-400">
						<a class="mt-2 text-blue-400 font-bold dark:text-green-200" href="#">
							{{$c->nombrePac}}
                        </a>
					</div>
					...
					<div
						...
						dark:text-gray-400">
						<a class="mt-2 text-red-400 font-bold dark:text-green-200" href="{{route('editConsulta', [$c->id_con])}}">
							{{$c->estado}}
                        </a>
					</div>
					<div
						class="mr-8 pr-10 flex flex-col capitalize text-gray-600
						dark:text-gray-400">
						<a class="mt-2 text-green-400 font-bold dark:text-green-200" href="{{route('showDocumentos', [$c->id_con])}}">
							Revisar
                        </a>
					</div>
				</div>
