			...
			<div
				...
				<div class="mr-13 flex capitalize">
					...
					<div
						...
						dark:text-gray-400">
						<a class="mt-2 text-green-400 font-bold dark:text-green-200" target="_blank" href="/storage/{{$d->id_consulta}}/{{$d->url_diagnostico}}">
							Ver
                        </a>
					</div>
				</div>
			...
			<div
				...
				<div class="mr-13 flex capitalize">
					...
					<div
						class="mr-16 pr-1 flex flex-col capitalize text-gray-600
						dark:text-gray-400">
						<a class="mt-2 text-green-400 font-bold dark:text-green-200" target="_blank" href="/storage/{{$e->id_consulta}}/{{$e->url_examen}}">
							Ver
                        </a>
					</div>
				</div>
