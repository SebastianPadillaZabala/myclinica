    ...
    <main
		...
		<div class="mx-10 my-2">
			...
			<div
				...
				<div class="ml-1 pl-2 flex capitalize">
					<!-- Left side -->
			...
			<div
				...
				<div class="mr-13 flex capitalize">
					...
					<div
						...
						dark:text-gray-400">
						<a class="mt-2 text-blue-400 font-bold dark:text-green-200" href="{{route('editPac', [$p->id_pac])}}">
							Editar
                        </a>
					</div>
					...
					<div
						...
						dark:text-gray-400">
						<a class="mt-2 text-green-400 font-bold dark:text-green-200" href="{{route('showHistorial',[$p->id_pac])}}">
							Revisar
                        </a>
					</div>
